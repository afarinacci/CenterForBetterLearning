  ...
  return (
    <main className="container-fluid paddingAround max800 effect8">
      ...
      <p>
        ...
        our environment. For some people, this happens in a step-by-step
        process, with each skill building upon the previous. For others, this
        system may be built on disorder, causing certain skills to be
        inefficient or ineffective. This disorder results in a patient that is
        struggling or taking longer than necessary to complete daily tasks. To
        improve the visual system, we need to embed, not just learn, new ways of
        taking in and processing visual information. We need to retrain the
        brain, and we do this by completing a vision therapy program.
      </p>
      <p>
        ...
        completing your annual comprehensive eye exam to make sure your eyes are
        healthy, we will perform additional testing to determine the
        functionality of the visual system. These additional tests will tell us
        how your eyes move, focus, work together, and how well you process
        visual information. We take into account the results of these additional
        tests, your signs and symptoms, and your visual needs to build a custom
        vision therapy program for you. A series of activities are presented to
        the patient under very controlled circumstances, practiced for
        reinforcement, and then built upon for enhancement of visual skills. The
        goal is not to strengthen eye muscles! Your eye muscles are already
        incredibly strong. Rather, the goal is to get the visual system
        functioning at optimal levels so as to improve one's quality of life.
        The length of the program depends on your goals, severity of the
        diagnosed conditions, and your dedication to home practice. Once the
      ...
      <p>
        We find most people who have come to this website for the same reasons:
      </p>
      <ol>
        <li>
          You are tired of the way things currently are and you are desperate to
      ...
      <p>
        If you are unsure if vision therapy is the right choice for you or your
        child. Please contact us at your earliest convenience. Our friendly and
        knowledgeable staff at Center for Better Learning will be glad to guide
        you through the process of determining if an undiagnosed visual problem
        is the source of your struggle.
      </p>
    </main>
  );
}
