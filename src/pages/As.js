  ...
  return (
    <div className="marginfornav">
      <div className="wideSectionBannerPrimary">
        <h1 className="text-center pageTitleOnDark">Amblyopia &amp; Strabismus</h1>
      </div>
      <main className="container-fluid paddingAround max800">
        <h4>What is amblyopia?</h4>
        <p>Amblyopia is commonly thought of as a type of "lazy eye". In amblyopia, there might not appear to be a noticeable problem of the eye. On the outside, the eye appears normal, but functionally, there are many issues that need to be resolved. It occurs when one eye is unable to achieve normal eyesight during visual development. In this case, even prescription lenses are unable to bring that eye to the sought after "20/20". Overtime, the disintegration between how the eyes and brain work together becomes magnified. The brain suppresses or ignores the signal from the weaker eye, depending only on input from the "good eye". Many amblyopes require vision therapy to regain operative use of central vision used in visual processing. This allows the child to regain visual function in both eyes, not one.</p>
        <br />

        <h4>What causes amblyopia?</h4>
        <ul>
        ...
        <h4>Is my child at risk factors for amblyopia?</h4>
        <ul>
          <li>Were they born premature?</li>
          <li>Were they born smaller than average?</li>
          <li>Do you have a family history of amblyopia, childhood cataracts or other eye conditions?</li>
          <li>Does your child have any developmental disabilities?</li>
        </ul>
        <br />

        <h4>What is Strabismus?</h4>
        <p>Strabismus is commonly known as "cross eyes". In a strabismic patient, the eyes do not line up, causing numerous issues with visual function and development. Two types of strabismus are esotropia and exotropia. Esotropia is defined by an inward turning eye, whereas exotropia is defined as an outward turning eye. In both strabismus and amblyopia (any type), the patient may experience double vision when trying to use both eyes, resulting in suppression of the weaker eye. In this case, the brain is no longer receiving input from both eyes, and the result is disruption or lack of the binocular vision system.</p>
        <br />

        <h4>What are signs &amp; symptoms of amblyopia and strabismus?</h4>
        <ul>
          <li>Squinting</li>
